...
class DreamGenerationConfig(GenerationConfig):
    def __init__(self, **kwargs):
        ...
        self.think_sample_interval = kwargs.pop("think_sample_interval", 8)
        # Special tokens that can be used at generation time
        self.mask_token_id = kwargs.pop("mask_token_id", None)
        self.expand_token_id = kwargs.pop("expand_token_id", None)
        self.delete_token_id = kwargs.pop("delete_token_id", None)
...
class DreamGenerationMixin:
    ...
    def _sample(
        ...
        for i in range(2 * max_gen_len + 2 * expand_budget):
            ...
            # for value=1, means attention is allowed
            # for value=0, means attention is not allowed
            ...
            # delete / it will not change the max_length
